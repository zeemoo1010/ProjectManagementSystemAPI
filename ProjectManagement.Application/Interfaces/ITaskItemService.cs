...
namespace ProjectManagement.Application.Interfaces
{
    ...
    {
        Task<BaseResponse<Guid>> CreateTaskItemAsync(CreateTaskItemDto taskItemDto, CancellationToken cancellationToken = default);
        ...
        Task<BaseResponse<bool>> TaskItemExistsAsync(Guid taskItemId, CancellationToken cancellationToken = default);
