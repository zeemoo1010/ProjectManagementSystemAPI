...
namespace ProjectManagement.Domain.Interfaces
{
    ...
    {
        Task<Guid> CreateTaskItemAsync(TaskItem taskItem, CancellationToken cancellationToken = default);
        ...
        Task<bool> TaskItemExistsAsync(Guid taskItemId, CancellationToken cancellationToken = default);
    }
}
